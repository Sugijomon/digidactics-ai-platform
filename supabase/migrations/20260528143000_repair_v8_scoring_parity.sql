-- Repair V8.1 scoring parity after the live Supabase function drifted from the
-- repository migration/docs.
--
-- This migration intentionally redefines calculate_v8_score with:
-- - context_multiplier in proportional exposure
-- - agentic_boost as an additive exposure boost
-- - whole-score persisted exposure, priority, and person scores
